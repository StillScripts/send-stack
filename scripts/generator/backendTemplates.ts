...
export const ${modelName}BackendSchema = withoutDefaults(createInsertSchema(${modelName}))

export const ${modelName}FrontendSchema = withoutDefaults(createInsertSchema(${modelName}))
`
}
